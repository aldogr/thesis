...
-export([new/3, new/5, new/6, new/7, hello/3]).
...
update_ef(PID, SetPoint, Feed, Dt, Ts) ->
    ...
    I0 = PID#pid.integral,
    I1 = I0 + Error,       %%*Dt,
    I2 = I1,%%%%%%%%%%%%%%%%%%clip_integral(PID, I1),
    D1 = 0, %%%%%%%%%%(Error - PID#pid.prev_error) / Dt,
...
{Output, I0,I1,PID#pid { integral=I2, prev_error=Error, timestamp=Ts } }.
